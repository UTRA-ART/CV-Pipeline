...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='yolov4.weights',
                        help='initial weights path')  # runs/train/exp94/weights/best.pt
    parser.add_argument(
        '--cfg', type=str, default='./cfg/yolov4-tiny.cfg', help='model.yaml path')
    parser.add_argument(
        '--data', type=str, default='data/PotholesFinal/potholes.yaml', help='data.yaml path')
    parser.add_argument(
    ...
    parser.add_argument('--img-size', nargs='+', type=int,
                        default=[448, 448], help='[train, test] image sizes')

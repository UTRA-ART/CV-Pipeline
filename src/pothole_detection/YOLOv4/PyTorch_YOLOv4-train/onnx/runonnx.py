...
def non_max_suppression(prediction, conf_thres=0.4, iou_thres=0.6, classes=None):
    """
...
def run_inference(img, onnx_weights):
    ...
    # Resize the image to [448, 448] and add padding
    ...
    pred = non_max_suppression(pred, conf_thres=0.5, iou_thres=0.8, classes=None)

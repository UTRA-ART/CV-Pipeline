...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights", nargs="+", type=str, default="", help="model.pt path(s)"
    )
    parser.add_argument(
        "--source", type=str, default="man.jpg", help="source"
    )  # file/folder, 0 for webcam
    parser.add_argument(
        "--output", type=str, default="inference/output", help="output folder"
    )  # output folder
    parser.add_argument(
        "--img-size", type=int, default=448, help="inference size (pixels)"
    )
    parser.add_argument(
        "--conf-thres", type=float, default=0.4, help="object confidence threshold"
    )
    parser.add_argument(
        "--iou-thres", type=float, default=0.8, help="IOU threshold for NMS"
    )
    parser.add_argument(

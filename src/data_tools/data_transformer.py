...
def shadow_round(image, num, seed, darken=0.4):
    ...
    ret = apply_mask(
        image,
        apply_gaussian(generate_mask_round(seed, num)),
        colour(image, bf=darken, gf=darken, rf=darken),
    )
...
def shadow_object(image, seed, darken=0.4, freq1=1, freq2=1, freq3=1, freq4=1):
    ...
    ret = apply_mask(
        image,
        generate_mask_object(seed, freq1=freq1, freq2=freq2, freq3=freq3, freq4=freq4),
        colour(image, bf=darken, gf=darken, rf=darken),
    )

...
[ 16, Conv, [256, 128, 3, 1]],   #34   --> #25
[ -1, Upsample, [None, 2, 'nearest']],  #35 --> #26
[ -1, BottleneckCSP, [128, 64, 1, False]],  #36 --> #27
[ -1, Conv, [64, 32, 3, 1]],    #37 --> #28
[ -1, Upsample, [None, 2, 'nearest']],  #38 --> #29
[ -1, Conv, [32, 16, 3, 1]],    #39 --> #30
[ -1, BottleneckCSP, [16, 8, 1, False]],    #40 --> #31
[ -1, Upsample, [None, 2, 'nearest']],  #41 --> #32
[ -1, Conv, [8, 2, 3, 1]] #42 Lane line segmentation head --> #33
]

...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    # Model parameters
    hyp['cls'] *= nc / 20.  # scale coco-tuned hyp['cls'] to current dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/exp100/weights/best.pt', help='initial weights path') #runs/train/exp94/weights/best.pt
    parser.add_argument('--cfg', type=str, default='./cfg/yolov4-tiny.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/FirstTest/data.yaml', help='data.yaml path')
